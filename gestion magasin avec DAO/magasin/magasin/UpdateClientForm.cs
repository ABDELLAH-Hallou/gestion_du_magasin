...
namespace magasin
{
    public partial class UpdateClientForm : Form,IClient
    {
        ...
        public void Update(Client client)
        {
            ...
            if (con != null)
            {
                String query = "update client set nom = @nom , prenom = @prenom , age = @age , adresse = @adresse , ville = @ville , specialite = @specialite , mail = @mail where idClient = @idClient;";
