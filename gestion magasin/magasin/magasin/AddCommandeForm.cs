...
namespace magasin
{
    public partial class AddCommandeForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String query = "insert into commande values (" + this.textBox1.Text.Trim() + ",'"+ dateTimePicker1.Value.ToString("yyyy-MM-dd") + "'," + this.textBox2.Text.Trim() + ");";
